  ...
  metaInfo: {
    ...
    meta: [
      ...
      },
      {
        vmid: 'description',
        name: 'description',
        content: '3D應用研發涉及多個技術領域，如計算機圖形學、計算機視覺、虛擬實境等。領燕科技掌握各種建模工具和渲染引擎，幫助客戶創造出逼真的立體場景、角色、特效等。  同時，3D技術在各行各業中都有著廣泛的應用。例如，在直播產業中，結合AI誕生了數字人，為主播帶來更豐富的內容與玩法；在建築和工程領域，幫助設計師和工程師更好地視覺化和模擬建築項目；在醫學領域 ，可以用來進行解剖學教學、手術模擬等。  隨著虛擬現實和人工智能的發展，領燕科技透過豐富的行業知識和多年的技術沉澱與3D相結合，創造出更智能和具現的應用，為以前我們只能在電影中看到的場景帶來了落地的可能性。',
      }
    ]
  },
  data() {
